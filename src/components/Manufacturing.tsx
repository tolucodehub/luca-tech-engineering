      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex items-start gap-4 p-6 bg-background rounded-xl shadow-sm">
            ...
            <div>
              <h3 className="font-semibold text-foreground mb-2">Modern Facility</h3>
              <p className="text-muted-foreground text-sm">
                Equipped with cutting-edge machinery and technology for precision manufacturing.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 p-6 bg-background rounded-xl shadow-sm">
            ...
            <div>
              <h3 className="font-semibold text-foreground mb-2">Expert Assembly</h3>
              <p className="text-muted-foreground text-sm">
                Skilled technicians ensuring every meter meets our exacting standards.
              </p>
            </div>
          </div>
