        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6 mb-12">
          {clients.map((client, index) => (
            <ScrollReveal key={index} delay={index * 50}>
              <div className="bg-white rounded-xl p-5 flex items-center justify-center hover:shadow-lg transition-all duration-300 group min-h-24 border border-border">
                <img
                  src={client.logo}
                  alt={client.name}
          ...
          <div className="mt-16 bg-card border border-border rounded-2xl p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-foreground leading-relaxed mb-8">
                Luca Tech Power Solution Limited has been instrumental in revolutionizing our
