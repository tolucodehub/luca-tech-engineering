    ...
    <section id="services" className="section-padding bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {[
            { src: installationWork, title: "Professional Installation", desc: "Expert meter installation" },
            { src: oilGasFacility, title: "Oil & Gas Operations", desc: "Industrial infrastructure" },
            { src: engineerControlPanel, title: "Technical Expertise", desc: "Expert engineers" },
            { src: teamMeeting, title: "Strategic Planning", desc: "Smart grid solutions" },
          ].map((item, index) => (
